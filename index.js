...
let allowedOrigins = ['http://localhost:8080', 'http://testsite.com', 'https://movie-madness-6651c785b11e.herokuapp.com', 'http://localhost:1234'];
...
app.get('/', (req, res) => {
    res.send('Welcome to Movie Madness!');
});
